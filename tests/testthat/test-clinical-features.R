...
test_that(".clinical_feature_field_name_generate", {
  ...
  expect_equal(
    .clinical_feature_field_name_generate(fake_db_conn, "last", "1104051000000101", 72),
    "last_sews_score_72h"
  )
  expect_equal(
    .clinical_feature_field_name_generate(fake_db_conn, "mean", "8480-6", 48),
    "mean_systolic_bp_48h"
  )
  expect_error(
    .clinical_feature_field_name_generate(fake_db_conn, c("mean", "mean"), c("8480-6", "1104051000000101"), 48)
  )
  expect_error(
    .clinical_feature_field_name_generate(fake_db_conn, "mean", "8480-6", NA)
  )
