...
# > recreate therapy episodes and combinations --------------------------------
  ...
  expect_equal(
    ...
    c(36.599999999991, 36.599999999991, 36.6499999999967, 36.680000000003, 
      36.680000000003, 36.7166666666625, 36.7285714285723, 36.7285714285723, 
      36.65, 36.65)
  )
  expect_equal(
    ols_temp$ols_temperature_24h_intercept[169:178],
    c(35.8333333333333, 36.05, 35.966666666668, 35.966666666668, 
      35.966666666668, 35.966666666668, 35.966666666668, 35.8333333333346, 
      35.8333333333346, 35.8333333333346)
  )
  expect_equal(
