...
test_that("bridge_episode_prescription_overlap on DuckDB", {
...
test_that("bridge_episode_prescription_initiation on DuckDB", {
...
test_that("bridge_episode_therapy_overlap on DuckDB", {
...
test_that("bridge_drug_prescriptions_date on DuckDB", {
...
test_that("bridge_inpatient_episodes_date on DuckDB", {
...
test_that("create_reporting_med_prescribing on DuckDB", {
