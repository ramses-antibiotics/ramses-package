...
<li>
  <p>Ramses links prescriptions together (by transitive closure) to reconstruct the <i>therapy episode, allowing more sophisticated observations:</i></p>
...
```{r get_therapy_table_code, eval=FALSE}
get_therapy_table(uti_episode, 
                  collect = TRUE)
```
```{r get_therapy_table_output, echo=FALSE, paged.print=TRUE}
get_therapy_table(uti_episode, collect = TRUE) %>% rmarkdown::paged_table() 
```
