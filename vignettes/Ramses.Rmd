...
In this example, we extract monthly total Defined Daily Doses, Days on Therapy, and Length of Therapy. Definitions correspond to those given by @Morris2014.
...
### Consumption based on the episode of initiation 
