             ...
             CASE
                 WHEN
                         (relation_type IN ('1', '5', '6')
                             AND
                          ABS(EXTRACT(EPOCH FROM (to_start::TIMESTAMP - from_start::TIMESTAMP))) / 3600 BETWEEN 0 AND @max_combination_start_gap
                 ...
                 WHEN
                         ...
                         (relation_type IN ('1', '2', '3', '7')
                             AND
                          ABS(EXTRACT(EPOCH FROM (to_start::TIMESTAMP - from_end::TIMESTAMP))) / 3600 <
